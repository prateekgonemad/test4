(function ($) {
    ...
    jQuery(document).ready(function($){
        ...
        /*----------------------------------------
            we offer carousel carousel
        ----------------------------------------*/
        var $weOfferCarousel = $('.we-offer-carousel');
        ...
        $weOfferCarousel.on("changed.owl.carousel", function (e) {
            var o = e.item.index + 1 - e.relatedTarget._clones.length / 2,
                n = e.item.count;
            (o > n || 0 == o) && (o = n - o % n), o--;
            $("#we-offer-item li:nth(" + o + ")").addClass('active').siblings().removeClass('active');
        });
